 ...
 */
const val ACTION_APPWIDGET_CREATED = "com.goflow.app.widgets.APPWIDGET_CREATED"

/**
 * Should be a subtype of [com.goflow.app.database.widget.WidgetEntity] to inject in the DAO with the
