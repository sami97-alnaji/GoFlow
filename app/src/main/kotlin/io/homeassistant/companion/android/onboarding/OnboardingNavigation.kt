...
import com.goflow.app.onboarding.connection.navigation.connectionScreen
import com.goflow.app.onboarding.connection.navigation.navigateToConnection
import com.goflow.app.onboarding.localfirst.navigation.LocalFirstRoute
import com.goflow.app.onboarding.localfirst.navigation.localFirstScreen
import com.goflow.app.onboarding.localfirst.navigation.navigateToLocalFirst
...
import com.goflow.app.onboarding.locationforsecureconnection.navigation.locationForSecureConnectionScreen
import com.goflow.app.onboarding.locationforsecureconnection.navigation.navigateToLocationForSecureConnection
import com.goflow.app.onboarding.locationsharing.navigation.LocationSharingRoute
import com.goflow.app.onboarding.locationsharing.navigation.locationSharingScreen
import com.goflow.app.onboarding.locationsharing.navigation.navigateToLocationSharing
import com.goflow.app.onboarding.manualserver.navigation.manualServerScreen
import com.goflow.app.onboarding.manualserver.navigation.navigateToManualServer
import com.goflow.app.onboarding.nameyourdevice.navigation.nameYourDeviceScreen
import com.goflow.app.onboarding.nameyourdevice.navigation.navigateToNameYourDevice
import com.goflow.app.onboarding.nameyourweardevice.navigation.nameYourWearDeviceScreen
import com.goflow.app.onboarding.nameyourweardevice.navigation.navigateToNameYourWearDevice
...
import com.goflow.app.onboarding.serverdiscovery.navigation.serverDiscoveryScreen
import com.goflow.app.onboarding.sethomenetwork.navigation.navigateToSetHomeNetworkRoute
import com.goflow.app.onboarding.sethomenetwork.navigation.setHomeNetworkScreen
import com.goflow.app.onboarding.wearmtls.navigation.URL_MTLS_DOCUMENTATION
import com.goflow.app.onboarding.wearmtls.navigation.navigateToWearMTLS
import com.goflow.app.onboarding.wearmtls.navigation.wearMTLSScreen
import com.goflow.app.onboarding.welcome.navigation.WelcomeRoute
import com.goflow.app.onboarding.welcome.navigation.welcomeScreen
import com.goflow.app.util.canGoBack
