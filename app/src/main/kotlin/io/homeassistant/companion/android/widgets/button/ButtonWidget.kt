...
import com.goflow.app.widgets.common.WidgetAuthenticationActivity
...
class ButtonWidget : AppWidgetProvider() {
    companion object {
        const val CALL_SERVICE =
            "com.goflow.app.widgets.button.ButtonWidget.CALL_SERVICE"
        private const val CALL_SERVICE_AUTH =
            "com.goflow.app.widgets.button.ButtonWidget.CALL_SERVICE_AUTH"
