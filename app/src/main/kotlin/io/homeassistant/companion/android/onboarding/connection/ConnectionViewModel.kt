...
internal class ConnectionViewModel @VisibleForTesting constructor(
    ...
    private fun injectCustomLogo(view: WebView) {
        ...
        if (existing == null) {
            viewModelScope.launch(Dispatchers.IO) {
                ...
                if (dataUrl != null) {
                    ...
                    view.post { injectCustomLogo(view) }
                }
            }
            return
        }
        ...
        val js = """
            (function() {
              ...
              if (!replaced && document.images && document.images.length) {
    ...
    private fun buildLogoDataUrl(context: Context): String? {
        return try {
            context.resources.openRawResource(R.drawable.ic_home_assistant_branding).use { stream ->
